...
export const en: TranslationKeys = {
  ...
  sidebar: {
    ...
    cliSessions: {
      ...
      pickerTitle: 'Open session',
      sessions: 'Sessions',
      loadingSessions: 'Loading sessions…',
      emptySessions:
        'No recorded sessions yet. Start a conversation to create one.',
    ...
    chatList: {
      ...
      searchLoading: 'Searching conversations...',
      ...
      cliConversations: 'Local CLI conversations',
  ...
  settings: {
    ...
    bots: {
      globalTitle: 'Global',
      enable: 'Enable Bot Platform',
      enableDesc: 'Start or stop all configured bot platform connections',
      ...
      noPlatforms: 'No bot platforms configured yet.',
      stop: 'Stop',
      start: 'Start',
      sessionsTitle: 'Sessions',
      sessionsDesc: 'Bot session mappings to conversations',
      ...
      unarchive: 'Unarchive',
      archive: 'Archive',
      deletePlatformTitle: 'Delete bot platform',
      deletePlatformMessage: 'Remove "{name}"? This cannot be undone.',
      addPlatformTitle: 'Add bot platform',
      ...
      form: {
        ...
        assistant: 'Bind Agent',
        assistantDesc: 'Which assistant handles messages from this platform.',
        enabled: 'Enabled',
        enabledDesc: 'Start bot when settings are saved.',
        botToken: 'Bot Token',
        botTokenDesc:
        ...
        whitelist: 'Whitelist',
        whitelistDesc: 'Only allow listed users and groups.',
        allowedUsers: 'Allowed Users',
        allowedUsersDesc: 'Platform sender IDs, comma-separated.',
        allowedGroups: 'Allowed Groups',
        allowedGroupsDesc: 'Platform group/chat IDs, comma-separated.',
        startupPolicy: 'Startup Update Policy',
        startupPolicyDesc:
          'Whether to process messages sent while the bot was offline.',
        startupPolicySkip: 'Skip pending',
        startupPolicyConsume: 'Consume pending',
        pollingInterval: 'Polling Interval',
        pollingIntervalDesc:
          'Milliseconds between long-poll requests (min 1000).',
        loginStatus: 'Login Status',
        loggedInAs: 'Logged in as {botId}',
        notLoggedIn: 'Not logged in yet',
        scanQrCode: 'Scan QR Code',
        scanQrCodeConfirmed:
          'WeChat login successful. Click Save to keep these credentials.',
        scanQrCodePrompt: 'Scan with WeChat',
        scanQrCodeScanned: 'Scanned — confirm the login on your phone.',
        scanQrCodeWaiting: 'Open WeChat and scan this code to log in.',
        scanQrCodeExpired:
          'QR code expired. Click "Scan QR Code" again to get a new one.',
        scanQrCodeError: 'QR login failed:',
        pollTimeout: 'Poll Timeout',
        pollTimeoutDesc: 'Milliseconds for each long-poll request.',
        ...
        clientId: 'Client ID',
        clientIdDesc: 'AppKey of the robot app',
        ...
        appId: 'App ID',
        appIdDesc: 'From the Feishu/Lark Open Platform app configuration page',
      ...
      picker: {
        ...
        telegramDesc: 'Bot API · long polling',
        weixinLabel: 'WeChat',
        weixinDesc: 'Personal account · official ClawBot interface',
    ...
    rag: {
      ...
      maintenanceUnavailableHint:
        'The RAG backend is not ready yet. Resolve the backend status above before running index maintenance.',
      ...
      manageEmbeddingDatabaseDesc:
        'Inspect per-model embedding stats and remove old index data when needed.',
      databaseExplorer: 'RAG database',
      backendCardTitle: 'RAG backend',
      searchMaintenance: {
        title: 'Search maintenance',
        desc: 'Clear the current index or remove relation history.',
        clearCurrent: 'Clear current index',
        purgeHistory: 'Clear relation history',
        clearComplete: 'Current search index cleared; history preserved.',
        clearFailed: 'Failed to clear current search index.',
        purgePrompt:
          'Enter {{confirmation}} to confirm clearing all relation history.',
        purgeConfirmationMismatch:
          'The confirmation text did not match. Nothing was cleared.',
        purgeComplete: 'Relation history cleared.',
        purgeFailed: 'Failed to clear relation history.',
      },
      deleteIndexActiveModelOnly:
        'Only the active embedding model index can be deleted.',
    ...
    scheduledTasks: {
      ...
      desc: 'Run agent prompts automatically on a schedule, or trigger them manually.',
      enableGlobal: 'Enable Scheduled Tasks',
      enableGlobalDesc:
      ...
      errorServiceUnavailable: 'Scheduled tasks service is not available yet',
      lastRun: 'Last run',
      neverRun: 'Never run',
      runNow: 'Run now',
      history: 'History',
      ...
      addTaskTitle: 'New scheduled task',
      editTaskTitle: 'Edit scheduled task: {name}',
      followCurrentAssistant: 'Follow current default assistant',
      ...
      errorCronInvalid: 'Invalid cron expression: {error}',
      errorIntervalRequired: 'Interval must be greater than 0 seconds',
      errorOnceRequired: 'Pick a run time',
      errorTimeoutRequired: 'Timeout must be greater than 0 seconds',
      fieldName: 'Name',
      namePlaceholder: 'Nightly summary',
      ...
      promptPlaceholder: 'Summarize what happened today...',
      fieldSchedule: 'Schedule',
      fieldIntervalSeconds: 'Interval (seconds)',
      fieldCronExpression: 'Cron expression',
      fieldTimezone: 'Timezone',
      fieldTimezoneDesc:
        'IANA timezone such as Asia/Shanghai. Leave blank for the host timezone.',
      fieldRunAt: 'Run at',
      ...
      runTriggeredBySchedule: 'Schedule',
      runTriggeredByManual: 'Manual',
      runTriggeredByAgent: 'Agent',
      runTriggeredByRetry: 'Retry',
      runNotFound:
        'Run record not found (it may have been pruned by retention).',
      runRetryScheduled: 'Retry #{attempt} scheduled at {time}',
      errorOnceInPast: 'The run time must be in the future',
      cronFormatHint: '* * * * * (minute hour day month weekday)',
      cronPlaceholder: '0 9 * * *',
      timezonePlaceholder: 'Asia/Shanghai',
      describeOnce: 'Runs once: {date}',
      describeOnceUnset: 'Runs once',
      describeInterval: 'Runs every {seconds}s',
      describeIntervalUnset: 'Runs on an interval',
      describeCron: 'Cron: {expr}',
      describeCronUnset: 'Cron expression',
      openQueueMonitor: 'Queue Monitor',
      queueMonitorTitle: 'Task Queue Monitor',
      queueStatusPending: 'Pending',
      queueStatusExecuting: 'Executing',
      queueStatusCompleted: 'Completed',
      queueStatusFailed: 'Failed',
      queueMaxConcurrent: 'Max concurrent',
      queuePaused: 'Paused',
      pauseQueue: 'Pause queue',
      resumeQueue: 'Resume queue',
      clearQueue: 'Clear queue',
      clearQueueTitle: 'Clear pending queue',
      clearQueueMessage:
        'Remove all pending (not yet executing) tasks from the queue? This cannot be undone.',
      queueExecutingSection: 'Executing',
      queueExecutingEmpty: 'Nothing is executing right now.',
      queueElapsed: 'Elapsed',
      queuePendingSection: 'Pending queue',
      queuePendingEmpty: 'No tasks are waiting in the queue.',
      queueBumpPriority: 'Move to front',
      fieldType: 'Task type',
      ...
      errorScriptPathRequired: 'Script path is required',
      enableScriptExecution: 'Allow script execution',
      ...
      allowedScriptDirectories: 'Allowed script directories',
      ...
      queueGroupPlaceholder: 'e.g. reports',
      fieldDependsOn: 'Depends on',
      fieldDependsOnDesc:
        'This task only runs once every selected task has finished in the same batch',
      noOtherTasks: 'No other tasks to depend on yet.',
      fieldContinueOnDependencyFailure: 'Continue if a dependency fails',
      ...
      retryInSeconds: 'Retry #{attempt} in {seconds}s',
      nextRunAt: 'Next: {time}',
      nextRunTodayAt: 'Today at {time}',
      timeJustNow: 'just now',
      timeInSeconds: 'in {count}s',
      timeMinutesAgo: '{count}m ago',
      timeInMinutes: 'in {count}m',
      timeHoursAgo: '{count}h ago',
      timeInHours: 'in {count}h',
      timeDaysAgo: '{count}d ago',
      timeInDays: 'in {count}d',
      describeIntervalHour: 'Every hour',
      describeIntervalHours: 'Every {count} hours',
      describeIntervalMinute: 'Every minute',
      describeIntervalMinutes: 'Every {count} minutes',
      cronDescEveryMinute: 'Every minute',
      cronDescEveryNMinutes: 'Every {count} minutes',
      cronDescEveryHour: 'Every hour',
      cronDescEveryNHours: 'Every {count} hours',
      cronDescWeekly: 'Every {weekday} at {time}',
      cronDescMonthly: 'Monthly on day {day} at {time}',
      cronDescDaily: 'Daily at {time}',
      queueBumpPriorityTooltip:
        'Only affects the currently queued run. To change the task priority permanently, edit the task.',
      allRunsHistory: 'All runs',
      allRunsHistoryTitle: 'All runs',
      logExpand: 'Show all logs ({count})',
      logCollapse: 'Hide logs',
      saveSuccessNotice: 'Task saved',
      createSuccessNotice: 'Task created',
      discardChangesTitle: 'Discard changes?',
      discardChangesMessage:
        'You have unsaved changes in this form. Discard them?',
      editFieldErrorHint: 'Fix the highlighted fields, then save again.',
      moreActions: 'More actions',
    },
  },
