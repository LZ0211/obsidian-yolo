  ...
  settings: {
    ...
    agent: {
      ...
      workspace: {
        ...
        toolBypassNotice: 'Gli agent con comandi da terminale o strumenti MCP di terze parti abilitati possono aggirare questo ambito: non è un confine di sicurezza.',
    ...
    providers: {
      ...
      cliInjection: {
        ...
        enabledLabel: 'Abilita iniezione provider',
        enabledDesc: 'Inietta credenziali e modello del provider configurato in YOLO nei processi runtime CLI.',
        providerLabel: 'Provider',
        providerDesc: 'I runtime CLI useranno endpoint e credenziali di questo provider.',
        modelLabel: 'Modello',
        modelDesc: 'I runtime CLI useranno questo modello (selezionabile dopo aver scelto un provider).',
        providerPlaceholder: 'Seleziona provider',
    ...
    models: {
      ...
      rerankModels: 'Modelli di rerank',
      addRerankModel: 'Aggiungi modello di rerank',
      editRerankModel: 'Modifica modello di rerank',
      noRerankModels: 'Nessun modello di rerank configurato',
    ...
    scheduledTasks: {
      ...
      desc: "Esegui automaticamente prompt dell'assistente secondo una pianificazione, oppure avviali manualmente.",
      enableGlobal: 'Abilita attività pianificate',
      enableGlobalDesc:
        'Attiva lo scheduler in modo che le attività a intervalli/cron/una tantum vengano eseguite automaticamente. "Esegui ora" funziona comunque in entrambi i casi.',
      addTask: '+ Nuova attività',
      noTasks: 'Nessuna attività pianificata.',
      serviceUnavailable:
        'Le attività pianificate non sono disponibili in questo ambiente (richiede un vault desktop).',
      errorServiceUnavailable:
        'Il servizio delle attività pianificate non è ancora disponibile',
      ...
      deleteTaskRunningWarning:
        'Questa attività è in esecuzione. L’eliminazione annullerà l’esecuzione corrente.',
      ...
      addTaskTitle: 'Nuova attività pianificata',
      editTaskTitle: 'Modifica attività pianificata: {name}',
      followCurrentAssistant: "Segui l'assistente predefinito attuale",
      scheduleInterval: 'Intervallo',
      scheduleCron: 'Espressione cron',
      scheduleOnce: 'Una volta',
      errorNameRequired: 'Il nome è obbligatorio',
      errorPromptRequired: 'Il prompt è obbligatorio',
      errorCronRequired: "L'espressione cron è obbligatoria",
      errorCronInvalid: 'Espressione cron non valida: {error}',
      errorIntervalRequired: "L'intervallo deve essere maggiore di 0 secondi",
      errorOnceRequired: 'Seleziona un orario di esecuzione',
      errorTimeoutRequired: 'Il timeout deve essere maggiore di 0 secondi',
      fieldName: 'Nome',
      namePlaceholder: 'Riepilogo notturno',
      fieldEnabled: 'Attiva',
      fieldAssistant: 'Assistente',
      fieldAssistantDesc:
        'Quale configurazione assistente utilizzare per eseguire questo prompt',
      fieldPrompt: 'Prompt',
      fieldPromptDesc:
        "Il messaggio inviato all'assistente ogni volta che questa attività viene eseguita",
      promptPlaceholder: 'Riassumi cosa è successo oggi...',
      fieldSchedule: 'Pianificazione',
      fieldIntervalSeconds: 'Intervallo (secondi)',
      fieldCronExpression: 'Espressione cron',
      fieldTimezone: 'Fuso orario',
      fieldTimezoneDesc:
        'Fuso IANA, ad esempio Asia/Shanghai. Vuoto per il fuso del sistema.',
      fieldRunAt: 'Esegui alle',
      fieldPriority: 'Priorità',
      fieldPriorityDesc:
        '1 (minima) a 10 (massima); le attività con priorità più alta vengono eseguite prima quando più attività sono in scadenza',
      fieldTimeout: 'Timeout (secondi)',
      fieldMaxRetries: 'Tentativi massimi',
      historyTitle: 'Cronologia esecuzioni: {name}',
      filterAll: 'Tutte',
      filterPending: 'In attesa',
      filterRunning: 'In esecuzione',
      filterCompleted: 'Completata',
      filterFailed: 'Non riuscita',
      filterCancelled: 'Annullata',
      filterTimedOut: 'Scaduta',
      statsTotal: 'Esecuzioni totali',
      statsSuccess: 'Successi',
      statsFailure: 'Fallimenti',
      statsSuccessRate: 'Percentuale di successo',
      statsAvgDuration: 'Durata media',
      filterLabel: 'Filtro',
      noRuns: 'Nessuna esecuzione ancora.',
      runDetailsTitle: 'Dettagli esecuzione: {name}',
      runTriggeredBy: 'Avviata da',
      runScheduledFor: 'Pianificata per',
      runStartedAt: 'Iniziata alle',
      runCompletedAt: 'Completata alle',
      runAttempt: 'Tentativo',
      runResult: 'Risultato',
      runError: 'Errore',
      runLogs: 'Log',
      runRetry: 'Riprova',
      runStatusPending: 'In sospeso',
      runStatusRunning: 'In esecuzione',
      runStatusCompleted: 'Completata',
      runStatusFailed: 'Fallita',
      runStatusCancelled: 'Annullata',
      runStatusTimedOut: 'Timeout',
      runTriggeredBySchedule: 'Pianificata',
      runTriggeredByManual: 'Manuale',
      runTriggeredByAgent: 'Agente',
      runTriggeredByRetry: 'Riprova',
      runNotFound:
        'Registro esecuzione non trovato (potrebbe essere stato ripulito dalla conservazione).',
      runRetryScheduled: 'Riprova #{attempt} pianificata alle {time}',
      errorOnceInPast: "L'orario di esecuzione deve essere nel futuro",
      cronFormatHint: '* * * * * (minuto ora giorno mese settimana)',
      cronPlaceholder: '0 9 * * *',
      timezonePlaceholder: 'Asia/Shanghai',
      describeOnce: 'Esegue una sola volta: {date}',
      describeOnceUnset: 'Esegue una sola volta',
      describeInterval: 'Esegue ogni {seconds}s',
      describeIntervalUnset: 'Esecuzione a intervalli',
      describeCron: 'Cron: {expr}',
      describeCronUnset: 'Espressione cron',
      openQueueMonitor: 'Monitor coda',
      queueMonitorTitle: 'Monitor coda attività',
      queueStatusPending: 'In attesa',
      queueStatusExecuting: 'In esecuzione',
      queueStatusCompleted: 'Completate',
      queueStatusFailed: 'Fallite',
      queueMaxConcurrent: 'Concorrenza massima',
      queuePaused: 'In pausa',
      pauseQueue: 'Metti in pausa la coda',
      resumeQueue: 'Riprendi la coda',
      clearQueue: 'Svuota la coda',
      clearQueueTitle: 'Svuota la coda in attesa',
      clearQueueMessage:
        'Rimuovere tutte le attività in attesa (non ancora in esecuzione) dalla coda? Questa operazione non può essere annullata.',
      queueExecutingSection: 'In esecuzione',
      queueExecutingEmpty: 'Al momento nessuna attività è in esecuzione.',
      queueElapsed: 'Tempo trascorso',
      queuePendingSection: 'Coda in attesa',
      queuePendingEmpty: 'Nessuna attività in attesa nella coda.',
      queueBumpPriority: 'Sposta in cima',
      fieldType: 'Tipo di attività',
      ...
      scriptPathPlaceholder: 'scripts/run.js',
      errorScriptPathRequired: 'Il percorso dello script è obbligatorio',
      enableScriptExecution: 'Consenti esecuzione script',
      enableScriptExecutionDesc:
        'Consente alle attività pianificate di tipo script di eseguire file .js relativi al vault in un worker thread. Lascia disattivato se non necessario.',
      allowedScriptDirectories: 'Directory script consentite',
      allowedScriptDirectoriesDesc:
        "Directory relative al vault da cui gli script possono essere eseguiti. Lascia vuoto per consentire l'intero vault.",
      allowedScriptDirectoriesPlaceholder: 'scripts',
      fieldQueueGroup: 'Gruppo di coda',
      fieldQueueGroupDesc:
        'Le attività che condividono lo stesso gruppo di coda non vengono mai eseguite contemporaneamente tra loro. Lascia vuoto per limitare la concorrenza solo tramite la policy globale della coda.',
      queueGroupPlaceholder: 'es. reports',
      fieldDependsOn: 'Dipende da',
      fieldDependsOnDesc:
        'Questa attività viene eseguita solo dopo che tutte le attività selezionate sono terminate nello stesso batch',
      noOtherTasks: "Nessun'altra attività da cui dipendere per ora.",
      fieldContinueOnDependencyFailure: 'Continua se una dipendenza fallisce',
      fieldContinueOnDependencyFailureDesc:
        'Se disattivato (predefinito), questa attività viene saltata definitivamente se una dipendenza fallisce o scade',
      runCancel: 'Annulla esecuzione',
      runCancelledNotice: 'Esecuzione annullata',
      retryInSeconds: 'Riprova #{attempt} tra {seconds}s',
      nextRunAt: 'Prossima: {time}',
      nextRunTodayAt: 'Oggi alle {time}',
      timeJustNow: 'adesso',
      timeInSeconds: 'tra {count}s',
      timeMinutesAgo: '{count} min fa',
      timeInMinutes: 'tra {count} min',
      timeHoursAgo: '{count} h fa',
      timeInHours: 'tra {count} h',
      timeDaysAgo: '{count} g fa',
      timeInDays: 'tra {count} g',
      describeIntervalHour: 'Ogni ora',
      describeIntervalHours: 'Ogni {count} ore',
      describeIntervalMinute: 'Ogni minuto',
      describeIntervalMinutes: 'Ogni {count} minuti',
      cronDescEveryMinute: 'Ogni minuto',
      cronDescEveryNMinutes: 'Ogni {count} minuti',
      cronDescEveryHour: 'Ogni ora',
      cronDescEveryNHours: 'Ogni {count} ore',
      cronDescWeekly: 'Ogni {weekday} alle {time}',
      cronDescMonthly: 'Mensile il giorno {day} alle {time}',
      cronDescDaily: 'Ogni giorno alle {time}',
      queueBumpPriorityTooltip:
        "Riguarda solo l'esecuzione attualmente in coda. Per cambiare la priorità dell'attività in modo permanente, modifica l'attività.",
      allRunsHistory: 'Tutte le esecuzioni',
      allRunsHistoryTitle: 'Tutte le esecuzioni',
      logExpand: 'Mostra tutti i log ({count})',
      logCollapse: 'Nascondi i log',
      saveSuccessNotice: 'Attività salvata',
      createSuccessNotice: 'Attività creata',
      discardChangesTitle: 'Annullare le modifiche?',
      discardChangesMessage:
        'Ci sono modifiche non salvate in questo modulo. Annullarle?',
